...
export const projects: Project[] = [
  ...
  { id: '8', slug: 'moxie', category: 'graphic-design', title: 'Moxie', blurb: 'A haircare brand that doesn’t exist yet — six pieces of it do.', problem: 'n/a — see full case study.', approach: 'n/a — see full case study.', outcome: 'n/a — see full case study.', accent: '#E6FF3C' },
